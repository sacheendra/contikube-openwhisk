...
node run-experiment.js 2 8 50 exp_results/1node
node run-experiment.js 4 8 50 exp_results/1node

# 16 cores
kubectl label nodes cloud3 openwhisk-role=invoker
node run-experiment.js 1 16 50 exp_results/2node
node run-experiment.js 2 16 50 exp_results/2node
node run-experiment.js 4 16 50 exp_results/2node
...
node run-experiment.js 2 32 50 exp_results/3node
node run-experiment.js 4 32 50 exp_results/3node
...
node run-experiment.js 2 64 50 exp_results/4node
node run-experiment.js 4 64 50 exp_results/4node
